...
Substitutes redirect-chain-analyzer, Redirect Chain Analyzer, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("redirect_chain_analyzer", "{slug_underscore}"),
    ("redirect-chain-analyzer", "{slug_kebab}"),
    ("Redirect Chain Analyzer", "{name}"),
    ("redirect-chain-analyzer", "{slug_kebab}"),
    ("Redirect Chain Analyzer", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
