...
This template instance (`redirect-chain-analyzer`) satisfies the structural requirements but uses placeholder methodology content. It is **not** marked complete as a collection tool — it is a scaffold proof.
